...
export class TreeOptions {
  ...
  constructor(private options: ITreeOptions = {}) {
    ...
    if (options.rtl) {
      this.actionMapping.keys[KEYS.RIGHT] = lodashGet(options, ['actionMapping', 'keys', KEYS.RIGHT]) || TREE_ACTIONS.DRILL_UP;
      this.actionMapping.keys[KEYS.LEFT] = lodashGet(options, ['actionMapping', 'keys', KEYS.LEFT]) || TREE_ACTIONS.DRILL_DOWN;
    }
  }
